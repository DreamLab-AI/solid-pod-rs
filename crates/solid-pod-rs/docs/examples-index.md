...
The quickest way to see a working pod is the bundled binary
(`cargo run -p solid-pod-rs-server`, see
[tutorial 01](tutorials/01-your-first-pod.md)); there is no standalone
